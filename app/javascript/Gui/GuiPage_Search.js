...
var installFocusKeyCallbacks = function () {
    ime.setKeyFunc(tvKey.KEY_ENTER, function (keyCode) {
        ...
        if (searchString != "") {
			...
			GuiPage_Search.ItemData = Server.Browse(url, "Search", "0", searchString, 0, 100, "", itemList);
    ...
    ime.setKeyFunc(tvKey.KEY_DOWN, function (keyCode) {
    	alert ("Down Key IME: " + GuiPage_Search.ItemData.length);
    	if (GuiPage_Search.ItemData.length > 0) {
    		//Turn On Screensaver
